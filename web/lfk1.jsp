<%-- 
    Document   : lfk1
    Created on : 15 Oct, 2016, 2:30:51 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
      ...
      {try
    {
      String query="select * from CPP_LANG";
...
%>
        <br> 
          ...
          <%=rs.getString("question")%>
            ...
            <span style="font-size: 30px; font-family: papyrus; color:black;">
...
%>
       ...
       <input style="margin-left: 10%; font-size: 25px;" type="submit" value="END EXAM">
